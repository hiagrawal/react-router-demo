...
const HomePage = props => {
  ...
  return (
    <div>
      <button onClick={() => props.history.push('/topics')}>Topics History</button>
      {/* <button onClick={() => `${props.match.url}/topics`}>Topics Link</button> */}
      <h1>HOME PAGE</h1>
    </div>
  );
};
...
const TopicsList = props => {
  ...
  return (
    <div>
      ...
      {/* <Link to={props.history.push('/topics/22')}>TO TOPIC 22</Link> */}
    </div>
  );
};
